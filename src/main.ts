...
import VueProgressBar, { Options } from "@aacassandra/vue3-progressbar";
...
const optionsProgressBar: Options = {
    color: primaryColor || "#4CAF50",
    failedColor: dangerColor || "#F44336",
    thickness: "4px",
    transition: {
        speed: "0.2s",
        opacity: "0.6s",
